import "./ServicesReadyToGetStartedBanner.css";

function ServicesReadyToGetStartedBanner() {
  return (
    <div className="ready-to-get-started">
      ...
      <img
        ...
        alt=""
      /> */}
      <img className="robot-img" src="assets/11.png" alt="" />
      <div className="main">
...
export default ServicesReadyToGetStartedBanner;
